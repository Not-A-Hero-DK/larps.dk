  ...
  private translations: Record<Locale, Translations> = {
    en: {
      ...
      footer: {
        ...
        brand_description:
          'Empowering the LARP community with free, professional hosting solutions.',
    ...
    da: {
      ...
      home: {
        ...
        subtitle:
          'Gratis hosting til LARP-fællesskaber verden over. Del dine eventyr, forbind med spillere og bring dine historier til live.',
      ...
      footer: {
        brand_title: 'Heimdal Portal',
        brand_description:
          'Styrker LARP-fællesskabet med gratis, professionelle hosting-løsninger.',
