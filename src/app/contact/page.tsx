          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-neutral-800/50 rounded-lg p-8 border border-neutral-700">
              ...
              {submitStatus === "success" && (
                <div className="mb-6 p-4 bg-green-800/20 border border-green-600/50 rounded-lg">
              ...
              {submitStatus === "error" && (
                <div className="mb-6 p-4 bg-red-800/20 border border-red-600/50 rounded-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-neutral-700 border rounded-lg text-white placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-accent transition-colors ${
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 bg-neutral-700 border rounded-lg text-white placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-accent transition-colors resize-vertical ${
