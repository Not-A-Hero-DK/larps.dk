              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <input
                    ...
                    autoComplete="name"
                    className={`w-full px-4 py-3 border rounded-lg bg-background text-foreground placeholder-muted transition-colors ${
                ...
                {/* LARP Name Field */}
                <div>
                  <label htmlFor="larpName" className="block text-sm font-medium text-foreground mb-2">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-lg bg-background text-foreground placeholder-muted transition-colors ${
                      errors.larpName ? 'border-red-500' : 'border-border focus:border-accent'
                    }`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 border rounded-lg bg-background text-foreground placeholder-muted transition-colors resize-vertical ${
            ...
            <div className="space-y-8">
              ...
              <div className="bg-card rounded-lg p-8 border border-border">
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-2">{t('contact.email_label')}</h3>
                    <p className="text-accent text-lg">{t('contact.email_address')}</p>
                  </div>

                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-2">{t('contact.response_time_label')}</h3>
                    <p className="text-muted">{t('contact.response_time')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card rounded-lg p-8 border border-border">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <span className="text-muted">{t('contact.need_larp_name')}</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-accent mr-3 mt-1">⚡</span>
                    <span className="text-muted">{t('contact.need_subdomain')}</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-accent mr-3 mt-1">⚡</span>
                    <span className="text-muted">{t('contact.need_participants')}</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-accent mr-3 mt-1">⚡</span>
                    <span className="text-muted">{t('contact.need_requirements')}</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-accent mr-3 mt-1">⚡</span>
                    <span className="text-muted">{t('contact.need_content')}</span>
                  </div>
                </div>
              </div>
            </div>
