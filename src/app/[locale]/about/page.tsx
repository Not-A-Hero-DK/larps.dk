...
export default function AboutPage() {
  ...
  return (
    <div className="pt-16">
      ...
      {/* Our Mission Section */}
      <section className="pt-16 px-8">
        <div className="max-w-5xl mx-auto bg-card rounded-lg p-6 border border-border">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-card rounded-lg p-6 border border-border">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <span className="text-muted">{t('about.offer_hosting')}</span>
                </div>
                <div className="flex items-start">
                  <span className="text-accent mr-3 mt-1">⚡</span>
                  <span className="text-muted">{t('about.offer_subdomains')}</span>
                </div>
                <div className="flex items-start">
                  <span className="text-accent mr-3 mt-1">⚡</span>
                  <span className="text-muted">{t('about.offer_templates')}</span>
                </div>
                <div className="flex items-start">
                  <span className="text-accent mr-3 mt-1">⚡</span>
                  <span className="text-muted">{t('about.offer_support')}</span>
                </div>
                <div className="flex items-start">
                  <span className="text-accent mr-3 mt-1">⚡</span>
                  <span className="text-muted">{t('about.offer_security')}</span>
                </div>
                <div className="flex items-start">
                  <span className="text-accent mr-3 mt-1">⚡</span>
                  <span className="text-muted">{t('about.offer_community')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border border-border">
              ...
              <p className="text-muted leading-relaxed">{t('about.who_description')}</p>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border border-border">
              ...
              <div className="space-y-4">
                <p className="text-muted leading-relaxed text-sm">{t('about.creator_description')}</p>
                <p className="text-muted leading-relaxed text-sm">{t('about.creator_background')}</p>
                <p className="text-muted leading-relaxed text-sm">{t('about.creator_mission')}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pt-16 px-8">
        <div className="max-w-5xl mx-auto text-center">
          <div className="bg-card rounded-lg p-6 border border-accent">
            ...
            <p className="text-lg text-muted mb-8 leading-relaxed">{t('about.cta_description')}</p>
