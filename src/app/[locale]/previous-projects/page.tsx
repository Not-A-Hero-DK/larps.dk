    ...
    <div className="relative min-h-screen text-foreground overflow-hidden">
      ...
      <section className="pt-32 pb-16 px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-header bg-clip-text text-transparent">{t('projects.previous_title')}</h1>
      ...
      <section className="py-16 px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted mb-12 leading-relaxed">{t('projects.archive_subtitle')}</p>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-8 text-center">
            <div>
              ...
              <div className="text-muted">{t('projects.total_adventures')}</div>
            </div>
            ...
            <div>
              ...
              <div className="text-muted">{t('projects.total_participants')}</div>
            </div>
          </div>
        </div>
      </section>
